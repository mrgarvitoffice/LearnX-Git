 ...
 * This file is part of the synchronized build for the Vercel path.
 */
...
const generateImageFromPromptFlow = aiForImages.defineFlow(
  {
    name: 'generateImageFromPromptFlow_Sync',
  ...
  async (input) => {
    try {
      ...
      console.error(`[AI Flow Error - Image Gen Sync] Error:`, error);
